...
export class ControlAreaComponent extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 100663679, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            ...
            Image.width(new BreakpointType({
                ...
                md: { "id": 100663640, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                lg: { "id": 100663504, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" }
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.margin({
                top: { "id": 100663626, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                bottom: this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? { "id": 100663622, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" } : { "id": 100663621, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" }
            });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Slider.create({ min: 0, max: this.max, step: 1, value: this.value });
            Slider.blockColor({ "id": 100663478, "type": 10001, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            Slider.selectedColor({ "id": 100663479, "type": 10001, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            Slider.trackColor({ "id": 100663480, "type": 10001, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            Slider.blockSize({
                width: { "id": 100663618, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                height: { "id": 100663618, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" }
            });
            ...
            Slider.height({ "id": 100663620, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            Slider.margin({
                left: new BreakpointType({
                    sm: { "id": 100663625, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                    md: { "id": 100663624, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                    lg: { "id": 100663623, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" }
                }).getValue(this.currentBreakpoint),
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontSize({ "id": 100663616, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.padding({
                left: { "id": 100663506, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                right: { "id": 100663506, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" }
            });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 100663677, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            __Image__controlImageBuilder();
            Image.width(this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? { "id": 100663508, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" } : { "id": 100663507, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            Image.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.isPlay ? { "id": 100663683, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" } : { "id": 100663682, "type": 20000, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" });
            __Image__controlImageBuilder();
            Image.width(new BreakpointType({
                sm: { "id": 100663534, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                md: { "id": 100663534, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" },
                lg: { "id": 100663535, "type": 10002, params: [], "bundleName": "com.huawei.music.musichome", "moduleName": "phone" }
            }).getValue(this.currentBreakpoint));
            Image.onClick(() => {
                if (this.isPlay) {
